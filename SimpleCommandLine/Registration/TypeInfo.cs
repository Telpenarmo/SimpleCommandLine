...
namespace SimpleCommandLine.Registration
{
    ...
    internal class TypeInfo
    {
        ...
        public TypeInfo(IEnumerable<ValueInfo> values, IEnumerable<OptionInfo> options, Delegate factory, string name = "")
        {
        ...
        public OptionInfo GetMatchingOptionInfo(OptionToken token) => Options.SingleOrDefault(x => x.MatchToken(token));
    }
}